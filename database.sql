...
--
-- Dumping data for table `chatbot_hints2`
--

INSERT INTO `chatbot_hints2` (`id`, `question`, `reply`) VALUES
...
--
-- Indexes for table `chatbot_hints2`
--
ALTER TABLE `chatbot_hints2`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `chatbot_hints2`
--
ALTER TABLE `chatbot_hints2`
